...
GAME_ICONS = {
    ...
    "snake": '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="28" width="8" height="8" rx="1" fill="#a7f070"/><rect x="16" y="28" width="8" height="8" rx="1" fill="#38b764"/><rect x="24" y="28" width="8" height="8" rx="1" fill="#a7f070"/><rect x="32" y="28" width="8" height="8" rx="1" fill="#38b764"/><rect x="32" y="20" width="8" height="8" rx="1" fill="#a7f070"/><rect x="40" y="20" width="8" height="8" rx="1" fill="#38b764"/><rect x="48" y="20" width="8" height="8" rx="1" fill="#a7f070"/><circle cx="52" cy="23" r="1.5" fill="#000"/><circle cx="55" cy="23" r="1.5" fill="#000"/><rect x="24" y="44" width="6" height="6" rx="1" fill="#ef7d57"/></svg>',
    "space-shooter": '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="29" y="12" width="6" height="20" rx="2" fill="#73eff7"/><rect x="24" y="22" width="16" height="8" rx="1" fill="#73eff7"/><rect x="20" y="26" width="4" height="6" fill="#41a6f6"/><rect x="40" y="26" width="4" height="6" fill="#41a6f6"/><rect x="31" y="14" width="2" height="3" fill="#a7f070"/><rect x="30" y="34" width="2" height="4" fill="#ef7d57"/><rect x="33" y="34" width="2" height="4" fill="#ef7d57"/><circle cx="15" cy="18" r="2" fill="#566c86"/><circle cx="50" cy="40" r="1.5" fill="#566c86"/><circle cx="42" cy="10" r="1" fill="#566c86"/><rect x="31" y="6" width="2" height="5" fill="#ffcd75"/><rect x="31" y="3" width="2" height="2" fill="#ffcd75"/></svg>',
